...
import { faBoxesStacked, faClipboardCheck, faCloudArrowDown, faCloudArrowUp, faCookieBite, faFolderOpen, faHourglassHalf, faPenToSquare, faTrashCan } from '@fortawesome/free-solid-svg-icons';

export default function Orders() {
    return (
        <>
            <div className="bg-white py-6 px-4 max-w-6xl relative shadow-default mx-auto mt-8 mb-8 rounded-default">
                <h2 className="text-green text-4xl max-sm:text-2xl font-extrabold mb-8">
                    <FontAwesomeIcon icon={faFolderOpen} /> Your Documents
                </h2>
                    ...
                    <table className="min-w-full border-separate border-spacing-0 border-4 border-green rounded-default">
                        ...
                        <tbody className="whitespace-nowrap">
                            <tr className="even:bg-gray text-sm text-black [&_td]:p-4">
                                <td>Purchase Order - 2</td>
                                <td>1.27Mb</td>
                                <td>11/20/2024</td>
                                <td>
                                    <button className="mr-4" title="Download">
                                        <FontAwesomeIcon icon={faCloudArrowDown} className="text-xl text-blue-500 hover:text-blue-700" />
                                    </button>
                ...
                <div className="flex justify-end mt-2">
                    ...
                    >
                        <FontAwesomeIcon icon={faCloudArrowUp} /> Upload Files
                    </button>
                </div>
                {/*Modal form used to upload documents. FLEX*/}
                <div className="hidden fixed inset-0 p-4 flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto">
            ...
            <div className=" bg-white py-6 px-4 max-w-6xl relative shadow-default mx-auto mb-8 rounded-default">
                <h2 className="text-green text-4xl max-sm:text-2xl font-extrabold mb-8">
                    <FontAwesomeIcon icon={faHourglassHalf} /> Current Orders
                </h2>
                <div className="overflow-x-auto pb-4">
                    <table className="min-w-full border-separate border-spacing-0 border-4 border-green rounded-default">
                        <thead className="bg-green whitespace-nowrap">
            ...
            <div className=" bg-white py-6 px-4 max-w-6xl relative shadow-default mx-auto rounded-default">
                <h2 className="text-green text-4xl max-sm:text-2xl font-extrabold mb-8">
                    <FontAwesomeIcon icon={faClipboardCheck} /> Completed Orders
                </h2>
                <div className="overflow-x-auto pb-4">
                    <table className="min-w-full border-separate border-spacing-0 border-4 border-green rounded-default">
                        <thead className="bg-green whitespace-nowrap">
